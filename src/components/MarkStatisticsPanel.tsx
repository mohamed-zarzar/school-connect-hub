...
export function MarkStatisticsPanel({
  ...
  showFilters = false,
  title = 'Official Mark Statistics',
}: Props) {
  ...
  // Compute expected student-subject pairs
  ...
  return (
    <Card>
      <CardHeader><CardTitle className="text-base flex items-center gap-2"><BarChart3 className="h-4 w-4" />{title}</CardTitle></CardHeader>
          ...
          <div className="space-y-4">
            ...
            <Card>
              <CardContent className="pt-4">
                <p className="text-sm font-medium mb-2">Overall Completion Rate</p>
