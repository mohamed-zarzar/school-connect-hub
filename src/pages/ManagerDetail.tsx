  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold flex-1">{manager.firstname} {manager.lastname}</h1>
        <QRCodeDisplay entityType="managers" entityId={manager.id} entityName={`${manager.firstname} ${manager.lastname}`} />
      </div>
